...
<li class="wc_payment_method payment_method_<?php echo esc_attr( $gateway->id ); ?>">
    <label class="form__radio" for="payment_method_<?php echo esc_attr( $gateway->id ); ?>">
    ...
    <div class="options" data-payment="<?php echo esc_attr( $gateway->id ); ?>" style="display: none;">

...
?><table id="addresses" cellspacing="0" cellpadding="0" style="width: 100%; vertical-align: top; margin-bottom: 40px; padding:0;" border="0">
	<tr>
		<td style="text-align:<?php echo esc_attr( $text_align ); ?>; font-family: 'Montserrat', sans-serif; border:0; padding:0;" valign="top" width="50%">
		...
		<?php if ( ! wc_ship_to_billing_address_only() && $order->needs_shipping_address() && $shipping ) : ?>
			<td style="text-align:<?php echo esc_attr( $text_align ); ?>; font-family: 'Montserrat', sans-serif; padding:0;" valign="top" width="50%">
				...
				<address class="address">
					...
					<?php echo $order->get_shipping_postcode(); ?>&nbsp;<?php echo $order->get_shipping_city(); ?><br>
